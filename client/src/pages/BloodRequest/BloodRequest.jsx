...
const BloodRequest = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    bloodtype: Yup.number().required('Invalid blood type selected').oneOf(
      [1, 2, 3, 4, 5, 6, 7, 8],
  ...
  const handleSubmit = async (values) => {
    try {
      const result = await axios.post('/api/bloodrequest', values);
      if (result && result.status === 201) {
        alert('Blood request placed successfully!');
        navigate('/');
      } else {
        alert('Failed to place blood request!');
      }
    } catch (error) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96 mt-10">
        <h2 className="text-2xl font-bold mb-6 text-center">Place Blood Request</h2>
        <Formik
          ...
          <div className="mb-4 hidden">
            ...
            <div className="mb-4">
              ...
              <Field
                ...
                disabled={true}
              />
              <ErrorMessage name="requesterName" component="div" className="text-red-500" />
            </div>
            ...
            <div className="mb-4">
              <label htmlFor="units" className="block text-gray-700 mb-2">
              ...
              <Field
                ...
                className="w-full p-2 border border-gray-300 rounded-md"
              />
              <ErrorMessage name="units" component="div" className="text-red-500" />
            </div>
